...
workflow vgMultiMap {
    input {
        ...
        String VG_CONTAINER = "quay.io/vgteam/vg:latest" # VG Container used in the pipeline
        ...
        # DeepVariant tontainer to use for cpus steps
...
task indexReference {
    ...
    command <<<
        ...
        java -jar /data/picard.jar CreateSequenceDictionary \
          R=ref.fa \
          O=ref.dict
    >>>
    output {
    ...
    runtime {
        ...
        docker: "chiarafolland/samtools_picard@sha256:a574d902f4f3f4de8d0eef9d4b262e0ce579d1ce1b491cc1de4f4ecd05190820"
    }
}
